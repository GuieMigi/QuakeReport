...
public class EarthquakeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<Earthquake>> {
    ...
    private static final String USGS_JSON_QUERY = "https://earthquake.usgs.gov/fdsnws/event/1/query";
    ...
    public Loader<ArrayList<Earthquake>> onCreateLoader(int i, Bundle bundle) {
        ...
        // The string that holds the current saved preference for the Minimum magnitude option.
        // getString retrieves a String value from the preferences. The second parameter is the default value for this preference.
        String minimumMagnitude = sharedPreferences.getString(
                getString(R.string.settings_min_magnitude_key),
                getString(R.string.settings_min_magnitude_default));

        // The string that holds the current saved preference for the Order By option.
        // getString retrieves a String value from the preferences. The second parameter is the default value for this preference.
        ...
        Uri baseUri = Uri.parse(USGS_JSON_QUERY);
        ...
        uriBuilder.appendQueryParameter("minmag", minimumMagnitude);
        uriBuilder.appendQueryParameter("orderby", orderBy);

        // Return the completed uri https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&limit=50&minmag=minimumMagnitude&orderby=time
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.earthquake_settings) {
